...
Public Sub LoadSettings()
    ...
    gPolyTypeColors(1) = HexToLong(LoadString("PolyTypeColors", "OnlyBullets"))
    gPolyTypeColors(2) = HexToLong(LoadString("PolyTypeColors", "OnlyPlayer"))
    gPolyTypeColors(3) = HexToLong(LoadString("PolyTypeColors", "DoesntCollide"))
    gPolyTypeColors(4) = HexToLong(LoadString("PolyTypeColors", "Ice"))
    gPolyTypeColors(5) = HexToLong(LoadString("PolyTypeColors", "Deadly"))
    gPolyTypeColors(6) = HexToLong(LoadString("PolyTypeColors", "BloodyDeadly"))
    gPolyTypeColors(7) = HexToLong(LoadString("PolyTypeColors", "Hurts"))
    gPolyTypeColors(8) = HexToLong(LoadString("PolyTypeColors", "Regenerates"))
    gPolyTypeColors(9) = HexToLong(LoadString("PolyTypeColors", "Lava"))
    gPolyTypeColors(10) = HexToLong(LoadString("PolyTypeColors", "TeamBullets"))
    gPolyTypeColors(11) = HexToLong(LoadString("PolyTypeColors", "TeamPlayers"))
    ...
    gPolyTypeColors(18) = HexToLong(LoadString("PolyTypeColors", "Bouncy"))
    gPolyTypeColors(19) = HexToLong(LoadString("PolyTypeColors", "Explosive"))
    gPolyTypeColors(20) = HexToLong(LoadString("PolyTypeColors", "HurtFlaggers"))
    gPolyTypeColors(21) = HexToLong(LoadString("PolyTypeColors", "OnlyFlagger"))
    gPolyTypeColors(22) = HexToLong(LoadString("PolyTypeColors", "NonFlagger"))
    gPolyTypeColors(23) = HexToLong(LoadString("PolyTypeColors", "FlagCollides"))
    gPolyTypeColors(24) = HexToLong(LoadString("PolyTypeColors", "Back"))
    gPolyTypeColors(25) = HexToLong(LoadString("PolyTypeColors", "BackTransition"))
