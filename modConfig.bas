...
Public Sub LoadSettings()
    ...
    frmTools.SetHotKey 0, LoadByte("HotKeys", "Move")
    frmTools.SetHotKey 1, LoadByte("HotKeys", "Create")
    frmTools.SetHotKey 2, LoadByte("HotKeys", "VertexSelection")
    frmTools.SetHotKey 3, LoadByte("HotKeys", "PolySelection")
    frmTools.SetHotKey 4, LoadByte("HotKeys", "VertexColor")
    frmTools.SetHotKey 5, LoadByte("HotKeys", "PolyColor")
    frmTools.SetHotKey 6, LoadByte("HotKeys", "Texture")
    frmTools.SetHotKey 7, LoadByte("HotKeys", "Scenery")
    frmTools.SetHotKey 8, LoadByte("HotKeys", "Waypoints")
    frmTools.SetHotKey 9, LoadByte("HotKeys", "Objects")
    frmTools.SetHotKey 10, LoadByte("HotKeys", "ColorPicker")
    frmTools.SetHotKey 11, LoadByte("HotKeys", "Sketch")
    frmTools.SetHotKey 12, LoadByte("HotKeys", "Lights")
    frmTools.SetHotKey 13, LoadByte("HotKeys", "DepthMap")

    errVal = "5"

    frmWaypoints.SetWaypointKey 0, LoadByte("WaypointKeys", "Left")
    frmWaypoints.SetWaypointKey 1, LoadByte("WaypointKeys", "Right")
    frmWaypoints.SetWaypointKey 2, LoadByte("WaypointKeys", "Up")
    frmWaypoints.SetWaypointKey 3, LoadByte("WaypointKeys", "Down")
    frmWaypoints.SetWaypointKey 4, LoadByte("WaypointKeys", "Fly")

    errVal = "6"

    frmDisplay.SetLayerKey 0, LoadByte("LayerKeys", "Background")
    frmDisplay.SetLayerKey 1, LoadByte("LayerKeys", "Polys")
    frmDisplay.SetLayerKey 2, LoadByte("LayerKeys", "Texture")
    frmDisplay.SetLayerKey 3, LoadByte("LayerKeys", "Wireframe")
    frmDisplay.SetLayerKey 4, LoadByte("LayerKeys", "Points")
    frmDisplay.SetLayerKey 5, LoadByte("LayerKeys", "Scenery")
    frmDisplay.SetLayerKey 6, LoadByte("LayerKeys", "Objects")
    frmDisplay.SetLayerKey 7, LoadByte("LayerKeys", "Waypoints")
