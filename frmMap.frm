...
'Private Sub txtTextureX_GotFocus()
    'txtTextureX.SelStart = 0
    'txtTextureX.SelLength = Len(txtTextureX.Text)
'End Sub

'Private Sub txtTextureX_KeyPress(KeyAscii As Integer)
'    If (KeyAscii >= 48 And KeyAscii <= 57) Or KeyAscii = 8 Then
'    Else
'        KeyAscii = 0
'    End If
...
'Private Sub txtTextureX_LostFocus()
    'If txtTextureX.Text < 32 Or txtTextureX.Text > 256 Then
    '    txtTextureX.Text = "128"
    'Else
    '    frmSoldatMapEditor.xTexture = txtTextureX.Text
    'End If
'End Sub

'Private Sub txtTextureY_GotFocus()
    'txtTextureY.SelStart = 0
    'txtTextureY.SelLength = Len(txtTextureY.Text)
'End Sub

'Private Sub txtTextureY_KeyPress(KeyAscii As Integer)
'    If (KeyAscii >= 48 And KeyAscii <= 57) Or KeyAscii = 8 Then
'    Else
'        KeyAscii = 0
'    End If
...
'Private Sub txtTextureY_LostFocus()
'    If txtTextureY.Text < 32 Or txtTextureY.Text > 256 Then
'        txtTextureY.Text = "128"
'    Else
'        frmSoldatMapEditor.yTexture = txtTextureY.Text
'    End If
'End Sub
